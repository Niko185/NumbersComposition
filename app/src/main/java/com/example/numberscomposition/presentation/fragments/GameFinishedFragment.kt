...
class GameFinishedFragment : Fragment() {
    ...
    private fun bindViews() {
        with(binding) {
            ...
            tvRequiredAnswers.text = String.format(
                ...
                gameResult.gameSettings.minCountAnswersForWinner
            )
            ...
            tvRequiredPercentage.text = String.format(
                ...
                gameResult.gameSettings.minPercentAnswersForWinner
            )
    ...
    private fun getPercentOfRightAnswers() = with(gameResult) {
        if (countAllQuestions == 0) {
            ...
            ((countRightAnswers / countAllQuestions.toDouble()) * 100).toInt()
        }
    }
    ...
    private fun parseArgs() {
        requireArguments().getSerializable(KEY_GAME_RESULT)?.let {
